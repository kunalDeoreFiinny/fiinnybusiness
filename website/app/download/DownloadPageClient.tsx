            ...
            <div className="pt-40 pb-24 px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                        ...
                        >
                            ...
                            <div className="text-center">
                                <p className="text-slate-400 font-medium text-xs mb-1">Download on the</p>
                                <h3 className="text-xl font-bold text-slate-900">App Store</h3>
                                <p className="text-slate-400 font-medium text-sm">iOS 15.0 or later</p>
                            </div>
                        ...
                        >
                            ...
                            <div className="text-center">
                                <p className="text-slate-400 font-medium text-xs mb-1">Get it on</p>
                                <h3 className="text-xl font-bold text-slate-900">Play Store</h3>
                                <p className="text-slate-400 font-medium text-sm">Android 8.0 or later</p>
                            </div>
                            <div className="px-6 py-3 rounded-full bg-slate-900 text-white font-bold text-sm w-full group-hover:bg-teal-600 transition-colors text-center">
                                Download Free
                            </div>
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-6">
                        <p className="font-bold text-slate-700 text-sm">Scan to download instantly</p>
