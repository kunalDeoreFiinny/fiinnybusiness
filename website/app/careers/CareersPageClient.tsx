...
import { ArrowRight, CheckCircle2, Clock, Briefcase, GraduationCap, Laptop } from "lucide-react";
            ...
            <section className="py-20 bg-white border-t border-slate-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-12">
                        ...
                        <p className="text-slate-500">Come join us and help ship real features used by real users. We&apos;re a team of N+1.</p>
                    </div>
        ...
        >
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 relative z-10">
                ...
                <div className="flex-shrink-0">
                    ...
                    >
                        Apply on LinkedIn <ArrowRight className="w-4 h-4 ml-2" />
                    </a>
                </div>
            </div>
        </motion.div>
