...
import { MapPin, Bell, ChevronRight, Phone, HelpCircle, Star } from 'lucide-react';
...
export function AccountPage() {
  ...
  const menuItems = [
    ...
    { icon: Star, label: 'My Saved Products', sub: 'Coming soon', action: () => {} },
    ...
    <div>
      <div style={{ background: 'linear-gradient(135deg, #16a34a 0%, #15803d 100%)', padding: '32px 16px 40px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 18, fontWeight: 700, color: '#fff', marginBottom: 4 }}>Hello, Farmer!</div>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.8)' }}>Browse products without signing in</div>
          </div>
        </div>
      </div>
